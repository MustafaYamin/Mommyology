...
const PartnersSection = () => {
  return (
    <section className="py-16 bg-gradient-to-r p-20 from-white to-[#F8F6FF]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          We collaborate with trusted partners who share our commitment to creating meaningful, joyful experiences for children. From playful adventures to unforgettable events, these collaborations help us bring out the wonder in every moment.
          </p>
        </motion.div>
          ...
          <div className="flex animate-scroll gap-8 min-w-max">
            {partners.concat(partners).map((src, idx) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="flex items-center justify-center h-24 w-40 gap-9 bg-white rounded-2xl shadow-lg border-2 border-[#6B5AA2]/20 p-4 transition-all duration-300 transform "
              >
